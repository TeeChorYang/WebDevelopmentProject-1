...
if(isset($_POST['submit'])){
    ...
    $send = mysqli_query($conn, "INSERT INTO bookair (fromcity, tocity, fullname, date, airline, address, city, zip, state, weight, material, shippingtype, paymethod, remark)
    VALUES ('$fromcity', '$tocity', '$fullname', '$date', '$airline', '$address', '$city', '$zip','$state', '$weight', '$material', '$shippingtype', '$paymethod', '$remark')");
    mysqli_close($conn);
...
<head>
    ...
    <title>Book Air - Radiant</title>
    <link rel="stylesheet" href="index.css">
    <link rel="stylesheet" href="bookair.css">
...
<div class="form shadow">
    <form action="" method="POST" id="air-form">
    <br>
        <p class="form-title text-center shadow rounded">Air Delivery Booking</p>
        ...
        <fieldset>
            <p class="">
                <select id="select" name="fromcity" id="fromcity" required>
            ...
            <p class="">
                <select id="select" name="tocity" id="tocity" required>
        ...
        <p class="air">
            <input type ="text" name="fullname" placeholder="Name" id="name" required></p>
            <input type ="date" name="date" placeholder="Date" id="date" required></p>
            <select id="select" name="airline" id="airline" required>
                    <option value="" disabled="" selected="">Air line</option>
                    <option value="Air Asia">Air Asia</option>
                    <option value="Malindo Airline">Malindo Airline</option>
            ...
            <button type="submit" name="submit" class="btn" style="color:blue">Proceed To Payment &rarr;</button>
        </fieldset>
    </form>
</div>
<br><br><br>
