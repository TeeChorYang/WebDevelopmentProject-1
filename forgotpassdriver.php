...
<head>
    ...
    <title>Driver Forgot Password - Radiant</title>
...
<body class="p-3 mb-2 bg-dark text-white">
    ...
    <!--Forgot Password-->
    <section class=" border border-warning border-4" style="margin-top:50px;" >
        <div class="container padding-bottom-3x mb-2 mt-5" >
            <div class="row justify-content-center" style="margin-left:-100px; margin-right:-100px; margin-bottom: 50px">
                <div class="col-lg-8 col-md-10">
                    ...
                    <form class="card mt-4 bg-dark border-secondary" id="i">
                        <div class="card-body">
