...
if(isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM vrddriver WHERE username='$username' AND password='$password'";
    ...
    if($count == 1){
        ...
        echo header ("Location: jobrequest.php");
    }else {
        echo '<script>alert("-- Driver Username or Password Incorrect -- \nLog In Unsuccessful, Please Try Again.")</script>';
    }
}
?>
...
<head>
    ...
    <title>Driver Sign In - Radiant</title>
    ...
    <section class="centerblocktext fontsignin">
        <div class="signinbox col-sm-12">
            <form class="form-signin" method="POST" action="">
                ...
                <br>
                <h1 class="h3 mb-3 font-weight-normal">Driver Sign In:</h1>
                <hr style="height:2px">

                <br>
                <label for="inputUname" class="sr-only">Driver Username:</label>
                <br>

                <input type="text" id="inputUname" name="username"class="form-control" placeholder="Username" required="" autofocus="">

                <br>
                <label for="inputPassword" class="sr-only">Driver Password:</label>

                <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Password" required="">


                <div class="col text-center">
                    <button class="btn btn-lg btn-outline-info btn-block" style="margin:20px" name="login" type="submit">Sign In as Driver</button>
                    <br><br>
                </div>

                <div class="">
                    <br>
                    <a href="forgotpassdriver.php" class="link-info">Forgot Password?</a>
                </div>
            </form>
        </div>
        <br><br>
