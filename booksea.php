...
if(isset($_POST['submit'])){
    ...
    $send = mysqli_query($conn, "INSERT INTO booksea (fromcity, tocity, fullname, date, shippingline, address, city, zip, state, weight, material, shippingtype, paymethod, remark)
    VALUES ('$fromcity', '$tocity', '$fullname', '$date', '$shippingline', '$address', '$city', '$zip','$state', '$weight', '$material', '$shippingtype', '$paymethod', '$remark')");
    mysqli_close($conn);
...
<div class="form shadow">
    <form action="" method="POST" id="Sea-form">
    <br>
        <p class="form-title text-center shadow rounded">Sea Delivery Booking</p>
        ...
        <fieldset>
            <p class="">
                <select id="select" name="fromcity" id="fromcity" required>
                    <option value="" disabled="" selected="">From City/Port</option>
            ...
            <p class="">
                <select id="select" name="tocity" id="tocity" required>
                    <option value="" disabled="" selected="">To City/Port</option>
                    <option value="Afganistan">Afghanistan</option>
                    <option value="Albania">Albania</option>
                    <option value="Algeria">Algeria</option>
                    <option value="American Samoa">American Samoa</option>
        ...
        <p class="air">
            ...
            <select id="select" name="shippingline" id="shippingline" required>
            ...
            <button type="submit" name="submit" class="btn">Proceed To Payment &rarr;</button>
        </fieldset>
    </form>
</div>
